 				...
 				<form action="editprofile.php" method="post">
 					...
 					<div class="row"  class="form-group">
 						...
 						<div class="col-md-8">
 							...
 							<div class="col-md-6"><p>course</p></div>
							<div class="col-md-6"><p class="value"></p></div>

							<div class="col-md-6"><p>Name</p></div>
							<div class="col-md-6"><p class="value"></p></div>

							<div class="col-md-6"><p>Father's name</p></div>
							<div class="col-md-6"><p class="value"></p></div>

							<div class="col-md-6"><p>Mother's name</p></div>
							<div class="col-md-6"><p class="value"></p></div>

							<div class="col-md-6"><p>Date of birth</p></div>
							<div class="col-md-6"><p class="value"></p></div>

							<div class="col-md-6"><p>Permanent address</p></div>
							<div class="col-md-6"><p class="value"></p></div>

							<div class="col-md-6"><p>Local address</p></div>
							<div class="col-md-6"><p class="value"></p></div>

							<div class="col-md-6"><p>email</p></div>
							<div class="col-md-6"><p class="value"></p></div>

							<div class="col-md-6"><p>Mobile no.</p></div>
							<div class="col-md-6"><p class="value"></p></div>

							<div class="col-md-6"><p>10th percentage/cgpa</p></div>
							<div class="col-md-6"><p class="value"></p></div>

							<div class="col-md-6"><p>Passing year (10th)</p></div>
							<div class="col-md-6"><p class="value"></p></div>

							<div class="col-md-6"><p>12th percentage/cgpa</p></div>
							<div class="col-md-6"><p class="value"></p></div>

							<div class="col-md-6"><p>Jee main score</p></div>
							<div class="col-md-6"><p class="value"></p></div>
	...
	<div class="blog">
			...
			<div class="container" style="margin-top:40px;">
				<div class="contact-form">
					...
					<div class="row">
						<div class="col-md-6"><p>Name</p></div>
						<div class="col-md-6"><p class="value"><?php echo $result['student_name']; ?></p></div>
						<div class="col-md-6"><p>Father's name</p></div>
						<div class="col-md-6"><p class="value"><?php echo $result['father_name']; ?></p></div>
						<div class="col-md-6"><p>Mother's name</p></div>
						<div class="col-md-6"><p class="value"><?php echo $result['mother_name']; ?></p></div>
						<div class="col-md-6"><p>Date of birth</p></div>
						<div class="col-md-6"><p class="value"><?php echo $result['dob']; ?></p></div>
						<div class="col-md-6"><p>permanent address</p></div>
						<div class="col-md-6"><p class="value"><?php echo $result['permanent_address']; ?></p></div>
						<div class="col-md-6"><p>Local address</p></div>
						<div class="col-md-6"><p class="value"><?php echo $result['local_address']; ?></p></div>
						<div class="col-md-6"><p>Email</p></div>
						<div class="col-md-6"><p class="value"><?php echo $result['email_id']; ?></p></div>
						<div class="col-md-6"><p>Mobile No</p></div>
						<div class="col-md-6"><p class="value"><?php echo $result['mobile_no']; ?></p></div>
						<div class="col-md-6"><p>Percentage of 10th /cgpa</p></div>
						<div class="col-md-6"><p class="value"><?php echo $result['percentage/cgpa']; ?></p></div>
						<div class="col-md-6"><p>year_passing(10th)</p></div>
						<div class="col-md-6"><p class="value"><?php echo $result['year_passing(10th)']; ?></p></div>
						<div class="col-md-6"><p>Percentage of 12th /cgpa</p></div>
						<div class="col-md-6"><p class="value"><?php echo $result['peercentage/cgpa']; ?></p></div>
						<div class="col-md-6"><p>year_passing(12th)</p></div>
						<div class="col-md-6"><p class="value"><?php echo $result['year_passing(12th)']; ?></p></div>
						<div class="col-md-6"><p>Jee main score</p></div>
						<div class="col-md-6"><p class="value"><?php echo $result['Jee_main_score']; ?></p></div>
						</div>
				</div>
				</div>
