                ...
                <ul class="nav navbar-nav navbar-right" style="font-size: 14px;">
                   ...
                   <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a href="#" targrt="#">Electronics&Communication</a></li>
...
<h1><center>Electronics and Communications Engineering</center></h1>
 <h2>About Us</h2>

                     Electronics and Communication Engineering has gained importance in recent years due to its versatile application in every facet of engineering field. It mainly deals with the principles of electronic devices and communication technologies along with the basic electronic components, design of circuits and systems.<br><br>

					The programmes are designed to produce professional Engineers who are capable of analyzing, specifying, designing, commissioning and maintaining complex electronic communications systems to enable continuous improvements in standards of living enjoyed by society through the ingenuity of engineers.<br><br>

					The courses open up a very wide range of employment opportunities, firstly by providing students with a comprehensive ground in engineering and electronics principles and then by allowing specialization that enables them to focus on a particular area of technology. This focus can be further enhanced by an appropriate choice of final-year project topic, which offers students an opportunity to acquire skills and experience in areas not otherwise covered by the main modules on the course. <br>

				<h2>Goals and Objectives:</h2><br>
				<ul>
				<li>Create conducive atmosphere in the department through which the students, especially from rural area will discover their own potential in Electronics and Communication Engineering and cater to the needs of industries of surrounding areas.</li><br>
				<li> Provide practical exposure to the students through modern laboratories with continuous upgradation.</li><br>
				<li>Provide opportunities to students to help upgrade their conceptual knowledge, by enhancing the information sources like Library, internet access facilities, etc.</li><br>
				<li>Create technical awareness among the students through special lectures from eminent resource persons, through industrial visits and in plant training.</li><br>
				<li> Provide opportunity to improve students' skills and competencies through participation in seminar, technical paper presentation and project works within the campus and at reputed companies.</li><br>
				<li>Improve the faculty performance through continuous education, organizing and participating in seminars, workshops, national and international conferences.</li><br>
				<li> Motivate both faculty and students to undertake research works and develop products through Industry and Institution co-operation.</li><br>
				<li>Offer Post Graduate Degree Programme with the specialization of DSP, Embedded Systems and Communication Systems.</li><br>
				<li>To make this institution a Center of Excellence in Electronics and Communication Engineering with specialization in DSP, VLSI, Embedded Systems and Communication Systems.</li>
				</ul>


			The department of Electronics and Communication Engineering has set the above objectives to fulfill the mission of the Department and thereby the vision of our college.
<h2>Vision</h2>
To achieve academic excellence by providing quality education in electronics and communication engineering including deep knowledge, learning and research facilities consistent with the global industrial and societal needs.
	<h2>Mission</h2>
							•	To provide excellence in education and research among students using tools and techniques of electronics and communication engineering.
<br>
							•	To build and develop various skill sets, expertise and ethical values among students for employment, entrepreneurship and societal use.<br>
							•	To inculcate the thirst of life-long learning of advanced technologies to reach heights of
