...
<head>
	...
	<meta name="keywords" content="GECA, GEC Ajmer, ECA, engineering, engineering colleg Government Engineering College Ajmer,Ajmer,Govt. Engg. college,TPO,Training & Placement Cell,Tpo Cell, TPO GECA,tpcell, placement cell, placement ajmer, Placement, Placements, tpo team" />
...
<section id="page-content">
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header" style="margin-top:0px;">Status</h1>
        ...
        <div class="row">
            ...
            <div class="col-lg-12" align="center" style="text-align:justify;">
                <img class="img-responsive" src="img/aaaa.png"  alt="tpo">
            </div>
